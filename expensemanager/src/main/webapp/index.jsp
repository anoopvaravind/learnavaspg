...
<body>
    <div class="cover">
        <h1>Expense Manager !!!<small></small></h1>
        <p class="lead">Please click 'Home' to continue..</p>
         <p class="lead"> <a href="<c:url value="/app/" />"><i class="fa fa-fw fa-dashboard"></i>Home</a></p>
    </div>
</body>
</html>
